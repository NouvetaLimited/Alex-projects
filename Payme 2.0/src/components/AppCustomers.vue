            ...
            <v-card>
                ...
                <v-data-table class="elevation-1" v-bind:headers="headers" v-bind:items="items" v-bind:search="search" v-bind:pagination.sync="pagination" hide-actions>
                    ...
                    <template class="body-2" slot="items" slot-scope="props">
                        ...
                        <td class="text-xs-left">{{ props.item.order_record }}</td>
                        <td class="text-xs-left">
                            <v-icon class="light" v-if="!props.item.first_name">block</v-icon>
                            <v-icon class="light" v-if="props.item.first_name">done</v-icon>
                        </td>
                        <td class="text-xs-left">
    ...
    export default {
        ...
        methods: {
            ...
            getCustomers () {
                ...
                data.append('TransactionType', 'getCustomer')
                data.append('keyword', '')
